...
@pytest.mark.parametrize("c_b_account, expected", [("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
...
def test_mask_account_card(c_b_account, expected):
    assert mask_account_card(c_b_account) == expected

@pytest.mark.parametrize("data_input, expected", [("2024-03-11T02:26:18.671407", "11.03.2024"),
                                                   ("2024vis-11T02:26:18.671407", "Дата введена не верно"),
                                                   ("", "Дата введена не верно"),
                                                   ("2024-03-11T02:26:18.671407123", "Дата введена не верно")])
def test_get_date(data_input, expected):
